...
fn test_f64() {
    ...
    round_trip_bytes(bson, vec![0x14,0x00,0x00,0x00,0x01,0x66,0x6c,0x6f,0x61,0x74,
...
fn test_str() {
    ...
    round_trip_bytes(bson, vec![0x15,0x00,0x00,0x00,0x02,0x73,0x74,0x72,0x00,0x07,
...
fn test_doc() {
    ...
    bson.insert("d", inner);
    round_trip_bytes(bson, vec![0x1d,0x00,0x00,0x00,0x03,0x64,0x00,0x15,0x00,0x00,
                          0x00,0x01,0x64,0x6f,0x75,0x62,0x6c,0x65,0x00,0x3d,
                          0x0a,0xd7,0xa3,0x70,0x3d,0x28,0x40,0x00,0x00]);
}
